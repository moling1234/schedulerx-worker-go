...
func newHeartbeatProcessor(connpool pool.ConnPool) actor.Process {
...
func (p *heartbeatProcessor) SendSystemMessage(pid *actor.PID, message interface{}) {
...
func (p *heartbeatProcessor) Stop(pid *actor.PID) {
	// do nothing
}
